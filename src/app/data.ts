...
`;
const block6 = `
(а) Я чувствовал бы себя подобно тому, кто удаляется в угол, чтобы придумать выход
из тупика перед развитием линии поведения
(b) Я был бы готов работать с тем, кто показал самый позитивный подход
(с) Я бы нашел способ уменьшения размеров задачи путем установления - какой
наилучший вклад могли бы внести различные индивидуальности
(d) Мое естественное чувство крайней необходимости помогло бы мне гарантировать,
что мы не отстанем от графика
(е) Я полагаю, что я сохранил бы хладнокровие и свою способность мыслить
объективно
...
(d) Я склонен становиться немного надоедливым, вполне вероятно, и полагаюсь на
одного-двух членов команды, поощряющих и воспламеняющих меня
(е) Я нахожу трудным начинать что-либо делать, если не ясны цели
(f) Иногда я не в состоянии объяснить и прояснить сложные вопросы, которые приходят
мне в голову
...
Убедитесь, что вопросы в каждой серии сводятся к 10, и итог для всех семи серий
равен 70.`;
